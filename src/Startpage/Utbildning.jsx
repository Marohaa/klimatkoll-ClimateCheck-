      ...
      <Row>
        {cardData.map((card) => (
          <Col key={card.id}  md={6}  className="mb-4">
            <Card className="h-100" style={{ backgroundImage: `url(${card.backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center', border: 'none',  minHeight: '400px', // Set a minimum height
                objectFit: 'cover', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}}>
